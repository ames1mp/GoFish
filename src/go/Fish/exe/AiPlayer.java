...
/**************************************************
 * Class for the AI opponent that extends the
 * player class.
 * @author Lanndon Rose
 * @author Michael Ames
...
/**
*A variable for the the holds the last rank the AI asked for. 
*/
...
/******************************************************************
 * This method is how the AI opponent chooses the card
 * he is going to ask the player for.
 * It checks to see if the AI has any multiples in its hand,
...
&& getHand().get(i).getSuit() != getHand().get(j).getSuit()) {
